        ...
        <div className="grid md:grid-cols-3 gap-8 items-center">
          ...
          <div className="bg-destructive/5 border border-destructive/20 rounded-2xl p-6 space-y-4">
            <div className="flex items-center gap-2 text-destructive">
              ...
              <span className="font-semibold">{t("problem.theProblem")}</span>
            </div>
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-muted-foreground">
                <XCircle className="w-4 h-4 mt-1 text-destructive shrink-0" />
                <span>{t("problem.item1")}</span>
              </li>
              <li className="flex items-start gap-2 text-muted-foreground">
                <XCircle className="w-4 h-4 mt-1 text-destructive shrink-0" />
                <span>{t("problem.item2")}</span>
              </li>
              <li className="flex items-start gap-2 text-muted-foreground">
                <XCircle className="w-4 h-4 mt-1 text-destructive shrink-0" />
                <span>{t("problem.item3")}</span>
              </li>
              <li className="flex items-start gap-2 text-muted-foreground">
                <XCircle className="w-4 h-4 mt-1 text-destructive shrink-0" />
                <span>{t("problem.item4")}</span>
              </li>
            </ul>
          </div>
          ...
          {/* Solution */}
          <div className="bg-primary/5 border border-primary/20 rounded-2xl p-6 space-y-4 box-glow-green">
            <div className="flex items-center gap-2 text-primary">
              <CheckCircle className="w-6 h-6" />
              <span className="font-semibold">{t("solution.theSolution")}</span>
            </div>
            <ul className="space-y-3">
